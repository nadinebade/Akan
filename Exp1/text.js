...
instructions_text.push(
  ...
  instructions_text.push(
    "<h1>Instructions (2/3)</h1><p>To play the audio recording of the Akan sentence, press the 'Play audio' button at the beginning of each trial. Please listen carefully until the end of the audio recording. Then please select how confident you are that the sentence was uttered by a speaker of Akan using the slider. It offers you different options between 'not confident at all' and 'very confident'.</p>");
