...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      validation: {
        ...
        default: '',
        description: 'If set to request, a box will appear if something is not answered'
      },
    }
  }
  plugin.trial = function(display_element, trial) {
    ...
    display_element.innerHTML += "<div id='jspsych-validation-dialog-multi-choice' class='jspsych-validation-dialog'></div>";
    ...
    trial_form.addEventListener('submit', function(event, toContinue) {
