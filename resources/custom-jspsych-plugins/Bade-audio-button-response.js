  ...
  class AudioButtonResponsePlugin {
      ...
      trial(display_element, trial, on_load) {
          ...
          const setupTrial = () => {
              ...
              html += '<button id="jspsych-audio-button-response-play" class="jspsych-btn">'+trial.play_button_label+'</button>';
              ...
              // start audio upon button press


              display_element
                  .querySelector("#jspsych-audio-button-response-play")
