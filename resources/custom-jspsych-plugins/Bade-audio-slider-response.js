var jsPsychAudioSliderResponse = (function (jspsych) {
  ...
  const info = {
      ...
      parameters: {
          ...
          button_delay: {
            type: jspsych.ParameterType.INT,
            pretty_name: "time until button appears",
            default: null,
        },
        prompt_delay: {
            type: jspsych.ParameterType.INT,
            pretty_name: "time until prompt appears",
            default: null,
        },
  ...
  class AudioSliderResponsePlugin {
      ...
      trial(display_element, trial, on_load) {
          ...
          const setupTrial = () => {
              ...
              } else { display_element.querySelector('#jspsych-audio-slider-response-prompt').style.visibility = "visible"; }
              ...
              } else { display_element.querySelector('#jspsych-audio-slider-response-replay').style.visibility = "visible"; }
        ...
        //        startTime = context.currentTime;
          ...
          //  }
           ...
           // }
              ...
              display_element
                  .querySelector("#jspsych-audio-slider-response-replay")
